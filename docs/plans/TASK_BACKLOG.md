...
| TASK-012 | 周期规则和实例（本地交付候选，待 PR/CI） | M5 | Sol | Extra High | TASK-007 |
...
| TASK-017 | 工资余额和年度统计 | M6 | Sol | High | TASK-016 |
| TASK-018 | 工资页面 | M6 | Terra | Medium | TASK-015,TASK-017 |
| TASK-019 | 攒钱目标 API | M7 | Sol | High | TASK-005 |
