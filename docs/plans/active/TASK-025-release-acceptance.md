...
仓库内开发、PR、远程 CI、合并和 main CI 已闭环；面向公众发布的外部条件阻断
...
仓库内开发、发布候选、PR、远程 CI、合并和最终 `main` CI 已完成闭环。TASK-025 的面向公众发布验收继续
等待正式 QQ、生产邮件、域名/TLS、staging/production、监控/回滚和品牌权属外部条件。负责人后续确认先交付
本人和女朋友使用的私有版本，因此个人部署口径由 TASK-026 按 ADR-035 单独闭环，不改写本任务历史证据。
