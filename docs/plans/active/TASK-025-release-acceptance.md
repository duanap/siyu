...
仓库内开发与发布候选验收完成，当前决定为不允许生产上线。正式关闭仍需：

- 代码提交、PR、远程 CI、合并和最终 `main` CI；
- 正式 QQ、生产邮件、域名/TLS、staging/production、监控/回滚和品牌权属外部验收。
