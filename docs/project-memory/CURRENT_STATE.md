...
更新时间：2026-07-22
文档版本：v1.20.0
代码状态：TASK-017 工资余额与年度统计已合并、远程 CI 全部通过并正式关闭；下一项为 TASK-018

## 当前阶段

M3、M4、M5 已完成并合入 `main`；M6 的 TASK-015、TASK-016、TASK-017 已正式关闭，准备进入 TASK-018。
...
通知读取/已读 API、工资页面、攒钱、导出、人工任务重试和后台业务管理均未实现。
...
从最新 `main` 创建 TASK-018 ExecPlan，完成工资页面的规则与设计复核、实现、真浏览器验收和远程闭环。
