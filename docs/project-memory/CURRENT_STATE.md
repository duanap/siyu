...
更新时间：2026-07-22
文档版本：v1.27.0
代码状态：TASK-021 站内通知已完成本地交付候选；待提交、PR、远程 CI、合并和 main CI 后正式关闭

## 当前阶段

M3、M4、M5、M6、M7 已完成并合入 `main`；M8 的 TASK-021 已完成本地开发、真实数据库和浏览器验收，等待远程交付门禁。
...
除周期待确认外的通知生产链路、通知偏好、邮件/短信/Push、导出、人工任务重试和后台业务管理均未实现。
...
提交 TASK-021 本地交付候选，完成 PR、远程 CI、合并和 main CI 后正式关闭，再进入 TASK-022 最小管理后台。
