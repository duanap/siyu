...
更新时间：2026-07-22
文档版本：v1.22.0
代码状态：TASK-018 工资页面已合并、远程 CI 通过并正式关闭；下一项为 TASK-019 攒钱目标 API

## 当前阶段

M3、M4、M5、M6 已完成并合入 `main`；TASK-018 已正式关闭，准备进入 M7 的 TASK-019。
...
进入 TASK-019 攒钱目标 API：先按已批准目标归属和贡献口径完成预检与 ExecPlan，再实现数据模型、迁移、
权限、幂等、事务、API 契约和完整 E2E。
