...
更新时间：2026-08-03
文档版本：v1.37.0
代码状态：TASK-027 首页与“我的”APP 化重构已形成本地交付候选；待提交、PR 与远程 CI
...
TASK-027 已按负责人选择的“方案 1 / 月度叙事”完成首页与“我的”本地开发：首页以月结为视觉主角，复用
真实周期实例和本人借贷形成失败隔离的待办；“我的”按共同生活、财务计划、数据与安全分组，并提供金额
隐藏和日间/夜间/跟随系统。该任务尚未提交或进入远程 CI，不标记为正式关闭。
...
先将 TASK-027 以独立提交序列进入 PR 和远程 CI；随后以负责人受控环境建立个人档案配置、备份与回滚点，
临时开放注册创建两个账号后关闭注册，并完成一次真实备份恢复与上线后观察。
