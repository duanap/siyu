...
更新时间：2026-07-22
文档版本：v1.18.0
代码状态：TASK-016 工资到账与收入联动已合并、远程 CI 全部通过并正式关闭；下一项为 TASK-017

## 当前阶段

M3、M4、M5 已完成并合入 `main`；M6 的 TASK-015、TASK-016 已正式关闭，准备进入 TASK-017。
...
从最新 `main` 创建 TASK-017 ExecPlan，完成工资余额与年度统计的规则复核、实现、验证和远程闭环。
