...
更新时间：2026-07-22
文档版本：v1.19.0
代码状态：TASK-017 工资余额与年度统计已完成本地交付候选和完整质量门；待提交、PR 与远程 CI

## 当前阶段

M3、M4、M5 已完成并合入 `main`；M6 的 TASK-015、TASK-016 已正式关闭，TASK-017 已完成本地交付候选。
...
提交 TASK-017 本地交付候选，完成 PR、远程 CI、合并和 main CI 正式闭环；随后进入 TASK-018 工资页面。
